...
namespace m1_sets {
	...
	/* State noise */
	const double STD_PX_NOISE = 0.01;
	const double STD_PY_NOISE = 0.01;
	const double STD_PZ_NOISE = 0.01;
	...
	const double STD_VYAW_NOISE = 0.015;		// Just model: 0.015
	const double STD_VPITCH_NOISE = 0.03;		// Just model: 0.03
	const double STD_VROLL_NOISE = 0.03;		// Just model: 0.03
